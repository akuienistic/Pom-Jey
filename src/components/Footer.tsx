        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-3 text-muted-foreground text-sm max-w-xs mx-auto">
              Turning everyday moments into sharp, shareable comedy. Available for brand collaborations, acting, and
              live appearances.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.to}>
                  <Link to={link.to} className="text-muted-foreground hover:text-secondary text-sm transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Social */}
          <div className="text-center">
            <h4 className="font-montserrat font-semibold text-foreground mb-4">Follow Me</h4>
