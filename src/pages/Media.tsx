...
const testimonials = [
  {
    quote: "Working with Pom Jey was an absolute pleasure. The content exceeded our expectations and drove real results for our campaign.",
    author: "Sarah Johnson",
    role: "Marketing Director",
    company: "TechStart Inc.",
  },
  {
    quote: "Pom brought incredible energy to our corporate event. Guests couldn't stop talking about the entertainment!",
    author: "Michael Chen",
    role: "Events Manager",
    company: "EventsPlus",
  },
          ...
          <div className="container">
            <div className="max-w-4xl">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed opacity-0 animate-fade-up delay-200">
                Top-performing content, testimonials from collaborators, and
                where to follow the latest.
              </p>
            </div>
          </div>
        </section>
              ...
              {topPosts.map((post, index) => (
                ...
                >
                  ...
                  <div className="aspect-video bg-muted flex items-center justify-center relative">
                    ...
                    <Play className="w-14 h-14 text-primary relative z-10 group-hover:scale-110 transition-transform" />
                  </div>
                  <div className="p-6">
        ...
        <section className="py-16 md:py-24">
          <div className="container text-center">
            ...
            <p className="section-subtitle mx-auto mb-10">
              Let's create content that gets noticed.
            </p>
